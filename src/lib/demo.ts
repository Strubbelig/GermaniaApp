...
const relatives: Relative[] = [
  ...
  rel('m4', 'child', 'Jonas', 'Vogel', 'male', '2010-03-17', 'Bahnhofstrasse 3', '8001', 'Zürich', 'CH'),
  rel('m4', 'child', 'Mia', 'Vogel', 'female', '2014-07-02', 'Bahnhofstrasse 3', '8001', 'Zürich', 'CH'),
  rel('m6', 'spouse', 'Rachel', 'Cohen', 'female', '1976-09-19', '5th Avenue 700', '10019', 'New York', 'US'),
  rel('m9', 'child', 'Paul', 'Hoffmann', 'male', '2008-01-05', 'Domkloster 4', '50667', 'Köln', 'DE'),
];
function rel(
